#Создание заявки на биржу со ставкой вручную
...
try:
    ...
    #Ввод логина
    browser.find_element(By.ID, "id_username").send_keys("andrew3")
    ...
    funciones.agregar_archivo("test.txt", "\n0 Заявка на биржу со ставкой вручную не создана")
    funciones.capture_screenshot()
else:
    funciones.agregar_archivo("test.txt", "\n1 Заявка на биржу со ставкой вручную успешно создана")

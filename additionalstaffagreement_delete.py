...
try:
    ...
    browser.find_element(By.XPATH, "//a[contains(@href, '/admin/stafflist/additionalstaffagreement/') and contains(@href, '/change')]").click()

    #переходим на новое окно
    browser.switch_to.window(browser.window_handles[1])

    #нажимаем на кнопку удалить Доп. часы по ТТ
    ...
    funciones.agregar_archivo("test.txt", "\n0 Доп. часы по ТТ не удалился")
else:
    funciones.agregar_archivo("test.txt", "\n1 Доп. часы по ТТ удалился")